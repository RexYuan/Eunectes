...
TODO: Let $r_i$ denote a \emph{row} $r_i$ is a function. A \emph{database} $\db = \set{r_1, r_2, ...}$ is a collection of rows. The set of all databases is denoted $\dbs$. The attributes of a $\db$ is $\mathcal{A} = \set{A_1, A_2, ...}$. The domain of $A_i$ is $\Omega_i$.
...
TODO: cite elements of info theory
...
TODO: mention in results we only tested binary predictions
...
TODO: N is multivariate normal distribution and sigma and identity function. I sub p

TODO: Da needs to take distributions. change symbols. lowercase phi
...
TODO: \subsection{Positive Results}
...
TODO: \subsection{Negative Results}
