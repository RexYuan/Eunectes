...
To circumvent the complexity explosion, instead, \cite{mckenna2021winning} devised a technique where the mutual information of all the database attribute pairs is calculated, and then a maximum spanning tree is obtained with edge weights being the mutual information to form a skeleton tree-shaped Markov random field.
